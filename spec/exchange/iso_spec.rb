...
describe "Exchange::ISO" do
  ...
  describe "self.definitions" do
    it "should be a hash of exactly the ISO standard definitions loaded from the yaml file" do
      expect(subject.definitions).to eq({
        ...
        :cuc=>{:separators=>{:major=>",", :minor=>"."}, :minor_unit=>2, :currency=>"Cuban Convertible Peso", :symbol=>nil},
        ...
        :btc=>{:separators=>{:major=>",", :minor=>"."}, :minor_unit=>2, :currency=>"Bitcoin", :symbol=>"B⃦"},
        :eek=>{:minor_unit=>2, :currency=>"Estonian Kroon", :symbol=>"kr"},
        :xag=>{:minor_unit=>2, :currency=>"Silver", :symbol=>"oz"},
        :xau=>{:minor_unit=>2, :currency=>"Gold", :symbol=>"oz"},
        :xpt=>{:minor_unit=>2, :currency=>"Platinum", :symbol=>"oz"},
        :xpd=>{:minor_unit=>2, :currency=>"Palladium", :symbol=>"oz"},
        :ggp=>{:minor_unit=>2, :currency=>"Guernsey Pound", :symbol=>"£"},
        :imp=>{:minor_unit=>2, :currency=>"Isle of Man Pound", :symbol=>"£"},
        :jep=>{:minor_unit=>2, :currency=>"Jersey Pound", :symbol=>"£"},
        :mtl=>{:minor_unit=>2, :currency=>"Maltese Lira", :symbol=>"Lm"}}
      )
    end
  end
